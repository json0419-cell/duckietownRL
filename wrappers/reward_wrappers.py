...
from core.lane_utils import get_lane_pos, pose_to_lane_frame
...
class LaneFollowingRewardWrapper(gym.Wrapper):
    ...
    def __init__(
        ...
        **legacy_kwargs,
        ...
        self.dist_penalty_alpha = float(dist_penalty_alpha)
    ...
    def step(self, action) -> Tuple:
        ...
        reward, dbg = self._duckietown_rl_reward(
            base,
            pose,
            float(base_reward),
            bool(terminated),
        ...
        if terminated:
            reward = -10.0
            reward_override = "terminated"
        dbg["reward_override"] = reward_override
