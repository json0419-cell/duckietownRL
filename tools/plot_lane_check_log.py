...
DEFAULT_OUT_ROOT = PROJECT_ROOT / "tools" / "lane_check_plots"
DEFAULT_TILE_SIZE = 0.585

from tools.draw_control_point_curves import (  # noqa: E402
    _canvas_transform,
...
def main():
    ...
    parser.add_argument(
        "--out-dir",
        default=None,
        help="Directory for outputs. Defaults to tools/lane_check_plots/<log_stem>.",
    )
